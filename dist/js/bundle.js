...
"use strict";
eval("\n\nvar _jquery = __webpack_require__(/*! jquery */ \"jquery\");\n\nvar _jquery2 = _interopRequireDefault(_jquery);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction display() {\n    var obj = {};\n    obj.userName = (0, _jquery2.default)(\"#userName\").val();\n    obj.password = (0, _jquery2.default)(\"#password\").val();\n    var obj = JSON.stringify(obj);\n    _jquery2.default.ajax({\n        type: \"POST\",\n        url: \"http://localhost:49980/api/Authentication/ValidateUser\",\n        data: obj,\n        crossDomain: true,\n        contentType: \"application/json; charset=utf-8\",\n        dataType: 'json',\n        success: function success(data) {\n            console.log(data);\n        },\n        error: function error() {\n            alert(\"error\");\n        }\n    });\n\n    //$.post( \"http://localhost:49980/api/Authentication/ValidateUser\", { \"userName\": \"this.userName\", \"password\": \"this.password\"} );\n    console.log(obj);\n}\n\n(0, _jquery2.default)(document).ready(function () {\n    // Handler for .ready() called.\n    (0, _jquery2.default)(\"#btnLoginSubmit\").click(display);\n    (0, _jquery2.default)(\"#searchIcon\").click();\n});\n\n//# sourceURL=webpack:///./src/authenticate.js?");

/***/ }),

/***/ 0:
/*!**************************************************!*\
  !*** multi babel-polyfill ./src/authenticate.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./src/authenticate.js */\"./src/authenticate.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./src/authenticate.js?");
